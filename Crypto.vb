...
#End Region
    ...
    Public Function ABC(A As String) As String
        ABC = "XYZ"
    End Function

    Public Function Encrypt(pwd As String) As String
        Crypto.EncryptionAlgorithm = Crypto.Algorithm.DES
        Crypto.Encoding = Crypto.EncodingType.HEX
        Crypto.Key = "Mat28:19"
        Crypto.EncryptString(pwd)
        Encrypt = Crypto.Content
        Crypto.Clear()
    End Function


    Public Function Decrypt(pwd As String) As String
        Crypto.EncryptionAlgorithm = Crypto.Algorithm.DES
        Crypto.Key = "Mat28:19"
        Crypto.Encoding = Crypto.EncodingType.HEX
        Crypto.Content = pwd
        Crypto.DecryptString()
        Decrypt = Crypto.Content
        Crypto.Clear()
    End Function
