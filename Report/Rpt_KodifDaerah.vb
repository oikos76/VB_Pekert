...
Public Class Rpt_KodifDaerah
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pekerti_Root.Rpt_KodifDaerah.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_KodifDaerah
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_KodifDaerah = New Rpt_KodifDaerah()
        rpt.Site = Me.Site
        Return rpt
    End Function
