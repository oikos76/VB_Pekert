...
Public Class Rpt_KodeProduk
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pekerti_Root.Rpt_KodeProduk.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_KodeProduk
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_KodeProduk = New Rpt_KodeProduk()
        rpt.Site = Me.Site
        Return rpt
    End Function
