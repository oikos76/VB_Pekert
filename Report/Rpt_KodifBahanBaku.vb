...
Public Class Rpt_KodifBahanBaku
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pekerti_Root.Rpt_KodifBahanBaku.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_KodifBahanBaku
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_KodifBahanBaku = New Rpt_KodifBahanBaku()
        rpt.Site = Me.Site
        Return rpt
    End Function
