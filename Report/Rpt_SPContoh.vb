...
Public Class Rpt_SPContoh
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pekerti_Root.Rpt_SPContoh.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_SPContoh
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_SPContoh = New Rpt_SPContoh()
        rpt.Site = Me.Site
        Return rpt
    End Function
