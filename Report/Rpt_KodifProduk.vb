...
Public Class Rpt_KodifProduk
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pekerti_Root.Rpt_KodifProduk.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_KodifProduk
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_KodifProduk = New Rpt_KodifProduk()
        rpt.Site = Me.Site
        Return rpt
    End Function
