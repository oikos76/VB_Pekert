...
Public Class Rpt_SaldoAkhir
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pekerti_Root.Rpt_SaldoAkhir.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_SaldoAkhir
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_SaldoAkhir = New Rpt_SaldoAkhir()
        rpt.Site = Me.Site
        Return rpt
    End Function
