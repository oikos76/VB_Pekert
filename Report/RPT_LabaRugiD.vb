...
Public Class RPT_LabaRugiD
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pekerti_Root.RPT_LabaRugiD.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_LabaRugiD
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_LabaRugiD = New RPT_LabaRugiD()
        rpt.Site = Me.Site
        Return rpt
    End Function
