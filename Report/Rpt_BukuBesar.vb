...
Public Class Rpt_BukuBesar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pekerti_Root.Rpt_BukuBesar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_BukuBesar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_BukuBesar = New Rpt_BukuBesar()
        rpt.Site = Me.Site
        Return rpt
    End Function
