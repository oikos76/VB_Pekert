...
Public Class Rpt_DPL_DaftarIsi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pekerti_Root.Rpt_DPL_DaftarIsi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_DPL_DaftarIsi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_DPL_DaftarIsi = New Rpt_DPL_DaftarIsi()
        rpt.Site = Me.Site
        Return rpt
    End Function
