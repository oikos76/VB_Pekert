...
Public Class RPt_NeracaPL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pekerti_Root.RPt_NeracaPL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPt_NeracaPL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPt_NeracaPL = New RPt_NeracaPL()
        rpt.Site = Me.Site
        Return rpt
    End Function
