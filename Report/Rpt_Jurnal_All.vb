...
Public Class Rpt_Jurnal_All
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pekerti_Root.Rpt_Jurnal_All.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Jurnal_All
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Jurnal_All = New Rpt_Jurnal_All()
        rpt.Site = Me.Site
        Return rpt
    End Function
