...
Public Class Rpt_KodifNegara
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pekerti_Root.Rpt_KodifNegara.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_KodifNegara
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_KodifNegara = New Rpt_KodifNegara()
        rpt.Site = Me.Site
        Return rpt
    End Function
