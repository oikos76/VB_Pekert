...
Public Class Rpt_KodifFungsi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pekerti_Root.Rpt_KodifFungsi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_KodifFungsi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_KodifFungsi = New Rpt_KodifFungsi()
        rpt.Site = Me.Site
        Return rpt
    End Function
