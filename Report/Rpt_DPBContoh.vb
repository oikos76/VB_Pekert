...
Public Class Rpt_DPBContoh
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pekerti_Root.Rpt_DPBContoh.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_DPBContoh
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_DPBContoh = New Rpt_DPBContoh()
        rpt.Site = Me.Site
        Return rpt
    End Function
